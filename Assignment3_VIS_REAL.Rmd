...
ggplot(zip_stops) +
  geom_sf(data= zip_stops, aes( fill= Freq)) +
  
  scale_fill_distiller(palette = "Spectral",
                       name = "Boston neighborhoods with \n highest number of 'Field \n Integration and Observation' stops",
...
ggplot(zip_stops) +
  geom_sf(data= zip_stops, aes( fill= Freq)) +
  scale_fill_manual(values = c(very_light, light, medium, dark, very_dark)) +
